...
<body>
    <div class="container">
        ...
        <p style="color: #6b7280; margin-bottom: 20px;">
            <?php echo count($tecnologias); ?> tecnologia(s) cadastradas(s)
        </p>
        ...
        <?php foreach ($tecnologias as $tec): ?>
            <div class="card">
                ...
                <a href="detalhe.php?id=<?php echo $tec['id']; ?>" style="color: #3b579d; font-size: 14px; font-weight: bold; display: inline-block; margin-top: 10px:">
                    Ver detalhes ->
                </a>
            </div>
        <?php endforeach; ?>
