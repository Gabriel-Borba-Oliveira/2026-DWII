...
<body>
    <div class="container">
        ...
        <div class="card">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margim-bottom: auto">
                <h1 class="titulo-secao" style="margin: 0;">
                    <?php echo htmlspecialchars($tec['nome']); ?>
                </h1>
                <span style="background: #e8edf5; color: #3b579d; padding: 4px 12px; border-radius: 20px; font-size: 14px; white-space: nowrap; margin-left: 12px;">
                    <?php echo htmlspecialchars($tec['categoria']); ?>
                </span>
            </div>

            <p><? echo htmlspecialchars($tec['descricao']); ?></p>
